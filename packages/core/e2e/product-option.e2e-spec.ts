...
describe('ProductOption resolver', () => {
    ...
    // Cross-channel update protection (PR #4821 guard)
    // Verifies that a channel-scoped admin cannot update a ProductOptionGroup
    // or ProductOption belonging to another channel.
    describe('cross-channel update protection', () => {
        ...
        beforeAll(async () => {
            ...
            // Create a ProductOptionGroup with an option in Channel A
